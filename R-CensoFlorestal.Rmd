...
GraficoClasseAltura <- grafico_bar(tempDistAlturas, tempDistAlturas$X, tempDistAlturas$Y, "Distribuição Hipsométrica", "Classe (m)", "Num. Fustes") #chama a função
...
GraficoClasseDiametro <- grafico_bar(tempDistDiam, tempDistDiam$X, tempDistDiam$Y, "Distribuição Diamétrica", "Classe (cm)", "Num. Fustes") #chama a função
