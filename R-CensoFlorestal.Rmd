...
remove(tmpAlt, tmpMeanAlt, tmpSDAlt, tmpC)

```


```{r}
#cria o gráfico de distribuição diâmetrica - obsoleto
...
#barplot(plotXY$plotY, ylim=c(0, max((plotY+10)*1.1)), col="#66BB66", xlab="Classe", #names.arg = plotXY$plotX, ylab="Número de Fustes", main="Distribuição Diamétrica", #axes=TRUE) #plota o grafico
